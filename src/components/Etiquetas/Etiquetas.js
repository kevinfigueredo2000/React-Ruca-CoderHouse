    ...
    return(
        <>
            ...
            <Container id="descubri-pc">
                <Row>
                    <div className="card col-lg-6 col-12 mb-3 mx-lg-1 shadow">
                        <Row className="my-lg-3 my-3">
                            ...
                            <div className="col-lg col-12">
                                <Row>
                                    ...
                                    <Link to="/categorias/1" className="col-lg-3 col-6 link"><button className="btn btn-primary verMas2">Ver más</button></Link>
                                </Row>
                            </div>
                        </Row>
                    </div>
                    <div className="card col-lg-6 col-12 mx-lg-1 shadow">
                        <Row className="my-sm-3 my-3">
                            <div className="col-lg mt-4 mx-4">
