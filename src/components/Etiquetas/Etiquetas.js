...
export const Etiquetas = () => {
    const { setCategory  } = useTiendaContext();
                    ...
                    <div className="card col-sm col-12 mb-lg-0 mb-3 me-lg-1 tags">
                        <Row className="my-lg-3 my-3">
                            <div className="col-lg mt-lg-4 mx-lg-4">
                                ...
                                <Link to={"tienda"} className="col-lg-3 col mt-auto" >
                                    <button className="btn btn-primary verMas1" onClick={()=>{setCategory("Termos")}}>Ver más</button>
                                </Link>
                            </div>
                            <div className="col-lg col-12">
                                <Row>
                                    ...
                                    <Link to={"tienda"} activeClassName="active" className="col-lg-3 col mt-auto"  onClick={()=>{setCategory("Termos")}}>
                    ...
                    <div className="card col-sm col-12 ms-lg-1 tags">
                        <Row className="my-lg-3 my-3">
                            <div className="col-lg mt-lg-4 mx-lg-4">
                                ...
                                <Link to={"tienda"} className="col-lg-3 col mt-auto" onClick={()=>{setCategory("Mate");}}>
                            ...
                            <div className="col-lg col-12">
                                <Row>
                                    ...
                                    <Link to={"tienda"} activeClassName="active" className="col-lg-3 col mt-auto" onClick={()=>{setCategory("Mate");}}>
                                        <button className="btn btn-primary verMas2">Ver más</button>
                                    </Link>
                                </Row>
                            </div>
